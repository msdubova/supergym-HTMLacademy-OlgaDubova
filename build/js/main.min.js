...
var swiperReviews = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.reviews__wrapper', {
  spaceBetween: 40,
  autoHeight: true,
  direction: 'horizontal',
  simulateTouch: true,
...
var swiperCoaches = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.coaches__slider', {
  spaceBetween: 0,
  slidesPerView: 1,
  direction: 'horizontal',
  simulateTouch: true,
...
swiperReviews.init();
swiperCoaches.init(); // Функция делает активным таб в разделе Абонементы

function setTab() {
  var subscription = document.querySelector('.tab');
  var titles = subscription.querySelectorAll('.tab__title');
  var tabs = subscription.querySelectorAll('.tab__block');
  var tabsBtn = subscription.querySelectorAll('.tab__button');
  var nav = subscription.querySelector('.subscription__nav');
  var buttons = subscription.querySelectorAll('.subscription__button');
  ...
  tabsBtn.forEach(function (item) {
    item.addEventListener('click', function () {
      ...
      var currentTab = subscription.querySelector(tabId);
      var currentButtons = currentTab.querySelectorAll('.subscription__button');
...
function setHover() {
  ...
  var _loop = function _loop(i) {
    items[i].addEventListener('click', function () {
      var currentCard = items[i];
      var currentId = currentCard.getAttribute('data-tab');
  ...
  var _loop2 = function _loop2(_i) {
    items[_i].addEventListener('mouseenter', function () {
      setHoverMouseEnter(items[_i]);
    });
  };
  ...
  var _loop3 = function _loop3(_i2) {
    items[_i2].addEventListener('mouseleave', function () {
      setHoverMouseLeave(items[_i2]);
    });
  };
...
function setJavaScript() {
  ...
  for (var _i3 = 0; _i3 < coaches.length; _i3++) {
    coaches[_i3].classList.remove('coaches__item--hover');
  }

  var buttons = document.querySelectorAll('.slider__button');

  for (var _i4 = 0; _i4 < buttons.length; _i4++) {
    buttons[_i4].classList.remove('visually-hidden');
  }

  var video = document.querySelector('.video__link--nojs');
  video.remove();
